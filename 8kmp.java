...
public class Main {
	...
	String line = "i0wej ewp wjpowjeg wpeogj wpegoj epofjspodfjspojwep ojwf posjdfs l;djgp" +
            "wope kweokf we[ k" +
            "woe fk[ewf[ wkf ewo[f kewop wk" +
            "weqpowiejqopsjkvnkzjbnoie";
    char [] text = line.toCharArray();
    char[] patt = {'w','o','p'};
    System.out.println(Arrays.toString(indexesOf(patt,text)));
